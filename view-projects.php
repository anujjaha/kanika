      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
			...
			<th>Project Id</th>
			<th>Project Title</th>
			<th>Project Post For Zip-Code</th>
			<th>Action</th>
			</tr>
			</thead>
			<tbody>
			...
			if(count($result) > 0)
			{
				...
				{ 
					...
					<tr>
						...
						<td><a href="view-job-view.php?jobid=<?php echo $result[$k]['intJobPostId']; ?>"><?php echo $result[$k]['vchJobPostTitle'];?></a></td>
						<td><?php 					
						...
						<td>
							<a class="btn btn-success open-bt" href="view-projects-bid.php?project_id=<?php echo $result[$k]['intJobPostId']; ?>">
								View
							</a>

							<a class="btn btn-primary open-bt" href="edit-job-post.php?id=<?php echo $result[$k]['intJobPostId']; ?>">
								Edit
							</a>
						</td>
					</tr>
